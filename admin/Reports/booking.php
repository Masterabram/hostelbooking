...
$w=array(20,40,45,32,30,27,27,18,15,15,15,15);
	...
	{ //width
		$this->Cell(20,6,$eachResult["transactionId"],1);
		$this->Cell(40,6,$eachResult["name"],1);
		$this->Cell(45,6,$eachResult["date"],1);
		$this->Cell(32,6,$eachResult["tell"],1);
        $this->Cell(30,6,$eachResult["student_id"],1);
		$this->Cell(27,6,$eachResult["duration"],1);
...
$header=array('Trans ID','Name','Date','Tell','Student ID', 'Duration');
//Data loading
//*** Load MySQL Data ***//
...
$pdf->AddPage();
	...
	$result=mysqli_query($mysqli,"Select * from booking") or die ("Database query failed: $query" . mysqli_error());
	
	$count = mysqli_num_rows($result);
	$pdf->Cell(0);
	$pdf->Write(5, ' Booking Report: '.$count.'');
	$pdf->Ln();
