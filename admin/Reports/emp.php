...
$w=array(40,50,32,30,27,27,18,15,15,15,15);
	...
	{ //width
        ...
        $this->Cell(30,6,$eachResult["nationalId"],1);
		$this->Cell(27,6,$eachResult["sex"],1);
...
$currDate = date('Y-m-d');
$strSQL = "Select* from systemadmin";
...
$pdf->AddPage();
	...
	$result=mysqli_query($mysqli,"Select * from systemadmin") or die ("Database query failed: $query" . mysqli_error());
	
	$count = mysqli_num_rows($result);
	$pdf->Cell(0);
	$pdf->Write(5, ' Employee Report: '.$count.'');
	$pdf->Ln();
