...
$w=array(40,50,32,30,27,27,18,15,15,15,15);
	...
	{ //width
		...
		$this->Cell(32,6,$eachResult["tel"],1);
        $this->Cell(30,6,$eachResult["idno"],1);
		$this->Cell(27,6,$eachResult["ownership"],1);
...
$header=array('Name','Email','Tell','National ID','Gender');
//Data loading
//*** Load MySQL Data ***//
...
$pdf->AddPage();
	...
	$result=mysqli_query($mysqli,"Select * from landlord") or die ("Database query failed: $query" . mysqli_error());
	
	$count = mysqli_num_rows($result);
	$pdf->Cell(0);
	$pdf->Write(5, ' Landlord Report: '.$count.'');
	$pdf->Ln();
