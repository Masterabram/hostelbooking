...
<?php
 ...
 //  } 
    ...
    $query = "SELECT * FROM systemadmin WHERE 1 AND  id = '{$_GET['id']}'";
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Personal Information Editor <?php echo $cred['name'] ?></h2>
                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST" action="edit_admin.php">

                    <span class="section">Personal Info</span>
                <input type="hidden" name="landId" value="<?php echo $cred['id']; ?>" >
