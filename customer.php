...
<div id="form_wrapper" class="form_wrapper">
   ...
   <td>   
     	  <label>Student Username:</label>
			<input type="text" name="studentId" id="username" required="required"/>
			<span class="error">This is an error</span>
   ...
   <td>   
			...
			<label> Phone:</label>
			<input type="text" name="tell" id="tell" required="required"/>
			<span class="error">This is an error</span>
   ...
   <tr>
      ...
      <td>   
			...
			<input type="text" name="dob" id="pcode" required="required"/>
			<span class="error">This is an error</span>
